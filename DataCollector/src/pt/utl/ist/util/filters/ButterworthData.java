...
/**
 * A Butterworth low/high pass and band pass/stop filter. The implementation
 * is based on a C version from http://www.exstrom.com/journal/sigproc
 * 
 * @author sikoried
 */
public class ButterworthData {
	private int n;
	 ...
	 */
	public ButterworthData(int order, double freq, double sampleRate, boolean lowp) {
		this.n = order;
	 ...
	 */
	public ButterworthData(int order, double freq1, double freq2, double sampleRate, boolean pass) {
		this.n = order;
...
//		double rate = 50;
//
//		ButterworthData bwf = new ButterworthData(n, f1, rate, true);
//		
//		System.out.println("a coeffs: ");
//		for(double a : bwf.getA()) System.out.println("\t"+ a);
//		System.out.println("b coeffs:");
//		for(double b : bwf.getB()) System.out.println("\t"+ b);
//	}
}
