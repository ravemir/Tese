...
import pt.utl.ist.util.filters.ButterworthFilter;
...
public class PeakAnalyser implements Observer {
	...
	private ArrayList<AccelReading> steps = new ArrayList<AccelReading>();
	...
	public ArrayList<AccelReading> getSteps() {
		return steps;
	}
	...
	public void processState(){
		...
		if(unaveragedPeaks.size() >= 2){
			...
			for(AccelReading r : unaveragedPeaks){
				// TODO If a peak is bigger than threshold...
